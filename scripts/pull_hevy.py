...
from backend.app.clients.hevy_client import HevyClient
from backend.app.db import create_workout, get_workout, update_workout
...
def upsert_workout(workout: Workout) -> Tuple[bool, str]:
    ...
    Returns (is_new, operation_type) where is_new indicates if created vs updated.
    """
    try:
...
async def main():
    ...
    try:
        ...
        logger.info(
            f"Sync completed: {new_count} new workouts, "
