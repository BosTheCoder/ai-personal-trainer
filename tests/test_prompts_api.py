...
from main import app, load_prompts, save_prompts  # noqa: E402, F401
...
class TestUpdatePrompt:
    ...
    def test_name_mismatch_error(self, client):
        ...
        response = client.put(
            "/prompts/url_name", json={"name": "body_name", "template": "test template"}
        )
    ...
    def test_invalid_request_body(self, client):
        ...
        response = client.put("/prompts/test_prompt", json={"invalid": "data"})
