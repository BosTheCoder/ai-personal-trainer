...
from app.services.hevy_sync import _map_workout_to_hevy_routine, push_workout_to_hevy
...
class TestHevySync:
    ...
    async def test_push_workout_to_hevy_success(self):
        ...
        mock_hevy_response = {
            "id": expected_routine_id,
            "title": "Workout from 2024-01-15 10:30",
        }

        with patch("app.services.hevy_sync.get_workout") as mock_get_workout, patch(
            "app.services.hevy_sync.HevyClient"
        ) as mock_hevy_client_class:
    ...
    async def test_push_workout_to_hevy_workout_not_found(self):
        ...
        with patch("app.services.hevy_sync.get_workout") as mock_get_workout:
            ...
            with pytest.raises(
                ValueError, match=f"Workout with ID {workout_id} not found"
            ):
    ...
    def test_map_workout_to_hevy_routine_empty_exercises(self):
        ...
        workout = Workout(
            id="test_workout", date=datetime(2024, 1, 15, 10, 30), exercises=[]
        )
